...
/////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////
inline void stage1(q15_t * pSrc16, uint32_t fftLen, q15_t * pCoef16, uint32_t twidCoefModifier) __attribute__((always_inline, unused));
...
void arm_cfft_radix4_q15_stage1(const arm_cfft_radix4_instance_q15 * S, q15_t * pSrc) {
    if (S->ifftFlag == 1u) {
        ...
        /*  Complex FFT radix-4  */
        stage1(pSrc, S->fftLen, S->pTwiddle, S->twidCoefModifier);
    }
}
...
void arm_cfft_radix4_q15_stage2(const arm_cfft_radix4_instance_q15 * S, q15_t * pSrc) {
    if (S->ifftFlag == 1u) {
        ...
        /*  Complex FFT radix-4  */
        stage2(pSrc, S->fftLen, S->pTwiddle, S->twidCoefModifier);
    }
}
...
void arm_cfft_radix4_q15_stage3(const arm_cfft_radix4_instance_q15 * S, q15_t * pSrc) {
    if (S->ifftFlag == 1u) {
        ...
        /*  Complex FFT radix-4  */
        stage3(pSrc, S->fftLen, S->pTwiddle, S->twidCoefModifier);
    }
...
void arm_radix4_butterfly_q15_all_stages(q15_t * pSrc16, uint32_t fftLen, q15_t * pCoef16, uint32_t twidCoefModifier) {
    ...
    stage1(pSrc16, fftLen, pCoef16, twidCoefModifier);
    /* data is in 4.11(q11) format */
    /* end of first stage process  */
    
    /*****************************************************************************************/
    /* start of middle stage process */
    stage2(pSrc16, fftLen, pCoef16, twidCoefModifier);
    ...
    stage3(pSrc16, fftLen, pCoef16, twidCoefModifier);
